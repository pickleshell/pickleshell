...
cp -a -- "$REPO/pickleshell-memory-broker/." "$FIXTURE/pickleshell-memory-broker/"
...
cp -- "$REPO/deploy/systemd/pickleshell-memory-broker.service.in" "$FIXTURE/deploy/systemd/"
cp -- "$REPO/deploy/systemd/pickleshell-memory-broker.sh.in" "$FIXTURE/deploy/systemd/"
