...
class TerminalService {
  ...
  reap() { const cutoff = Date.now() - this.policy.ttlMs; for (const t of this.terminals.values()) if (Date.parse(t.lastActivityAt) < cutoff && t.state !== 'closed') this.close(t, 'ttl_expired').catch(() => {}); }
}
